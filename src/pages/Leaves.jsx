    ...
    <>
       <div className="grid items-center my-2 mx-10 ">
        <table className=" border-b  min-w-full  text-center text-md bg-white  -mt-24 rounded-[10px] overflow-hidden shadow-lg">
          ...
          <tbody>
            {leaves.map((leave) => (
              <tr key={leave.id} className=" border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                <td className="whitespace-nowrap px-6 py-4">{leave.leave_from}</td>
                <td className="whitespace-nowrap px-6 py-4">{leave.leave_to}</td>
                <td className="whitespace-nowrap px-6 py-4">{leave.leave_type}</td>
                <td className="whitespace-nowrap px-6 py-4">{leave.leave_letter}</td>
                <td className="whitespace-nowrap px-6 py-4">leave employees_on_leave</td>
